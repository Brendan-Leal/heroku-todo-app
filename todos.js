...
// Detect unauthorized access to routs
...
app.post("/lists",
    ...
    catchError(async (req, res) => {
        ...
        if (!errors.isEmpty()) {
            ...
            req.flash("error", "That list title is already in use.");
            renderNewList();
        } else {
...
app.post("/users/signin",
    catchError(async (req, res) => {
        ...
        let validUser = await res.locals.store.authenticateUser(password, username);
